                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-12">
                        ...
                        <input type="text" class="form-control @error('nama_kepala_keluarga') is-invalid @enderror"
                            name="nama_kepala_keluarga" value="">
                    </div>
                    <div class="col-lg-12">
                    ...
                    <div class="modal-footer">
                        <a class="btn btn-primary" href="{{ route('datakematian.index') }}">Kembali ke Daftar Data
                            Kematian</a>
