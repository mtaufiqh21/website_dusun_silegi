    ...
    <div class="col-md-6 col-lg-12">
        <div class="card">
            <div class="card-header">
                <h4>Seluruh Data Pendapatan</h4>
            </div>
            <div class="card-body p-0">
                <p class="px-4">Berikut adalah daftar seluruh Pendapatan.</p>
                    ...
                    <table id="example" class="table table-striped" style="width:100%">
                        <thead>
                            <tr>
                                ...
                                <th style="text-align: center !important;">Nominal Pendapatan</th>
                        ...
                        <tbody>
                            @foreach ($pendapatans as $item)
                                <tr style="text-align: center !important;">
                                    ...
                                    <td style="text-align: center !important;"> {{$item->nominal_pendapatan}} </td>
                                    <td style="text-align: center !important;" > {{ $item->tahun }} </td>
                                    @if ($item->active_status === 1)
                                        <td>
                                            <div class="badge badge-success">Active</div>
                                        </td>
                                    ...
                                    @endif
                                    <td>
                                        <a href="{{ route('pendapatan.destroy', $item->id) }}" class="btn btn-danger"
                                            data-confirm-delete="true">Delete</a>
                                        <a href="{{ route('pendapatan.edit', $item->id) }}" class="btn btn-warning">Edit</a>
                                        <a href="{{ route('pendapatan.show', $item->id) }}" class="btn btn-info">Detail</a>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
