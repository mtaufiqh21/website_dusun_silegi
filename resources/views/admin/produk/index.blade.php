...
@section('title', 'Dashboard Produk Dusun')
        ...
        <div class="card">
            ...
            <div class="card-body p-0">
                ...
                <div class="m-3 d-flex align-items-center justify-content-end">
                    <a href="{{ route('produk-dusun.create') }}" class="btn btn-success">Tambah Berita</a>
                </div>
                    ...
                    <table id="example" class="table table-striped" style="width:100%">
                        <thead>
                            <tr>
                                ...
                                <th style="text-align: center !important;">JUDUL</th>
                                <th style="text-align: center !important;">DESKRIPSI SINGKAT</th>
                        ...
                        <tbody>
                            @foreach ($products as $item)
                                <tr style="text-align: center !important;">
                                    ...
                                    @endif
                                    <td>
                                        {{-- <form action="{{ route('produk-dusun.destroy', $item->id) }}" method="POST"
                                            style="display: inline;">
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit" class="btn btn-danger" data-confirm-delete="true">Delete</button>
                                        </form> --}}
                                        <a href="{{ route('produk-dusun.destroy', $item->id) }}" class="btn btn-danger"
                                            data-confirm-delete="true">Delete</a>
                                        <a href="{{ route('produk-dusun.edit', $item->id) }}"
                                            class="btn btn-warning">Edit</a>
                                        <a href="{{ route('produk-dusun.show', $item->id) }}"
