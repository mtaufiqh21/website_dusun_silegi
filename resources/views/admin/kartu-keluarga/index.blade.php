...
@section('title', 'Dashboard Kartu Keluarga')
    ...
    <div class="col-md-6 col-lg-12">
        <div class="card">
            <div class="card-header">
                <h4>Seluruh Data Kartu Keluarga</h4>
            </div>
            <div class="card-body p-0">
                <p class="px-4">Berikut adalah daftar seluruh Kartu Keluarga.</p>
                <div class="m-3 d-flex align-items-center justify-content-end">
                    <a href="{{ route('kartu-keluarga.create') }}" class="btn btn-success">Tambah Kartu Keluarga</a>
                </div>
                <div class="table-responsive">
                    ...
                    {{-- <table class="table table-striped table-md">
                        ...
                        <tbody>
                            @foreach ($kartu-keluarga as $item)
                                <tr>
                                    <td> {{ $item->id }} </td>
                                    <td> {{ $item->title }} </td>
                                    <td> {{ $item->slug }} </td>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{ route('kartu-keluarga.edit', $item->id) }}" class="btn btn-warning">Edit</a>
                                        <a href="{{ route('kartu-keluarga.show', $item->id) }}" class="btn btn-info">Detail</a>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
                    ...
                    <table id="example" class="table table-striped" style="width:100%">
                        <thead>
                            <tr>
                                ...
                                <th style="text-align: center !important;">NOMOR HANDPHONE</th>
                                <th style="text-align: center !important;">BUKTI KARTU KELUARGA</th>
                                <th style="text-align: center !important;">WILAYAH</th>
                                <th style="text-align: center !important;">RT</th>
                                <th style="text-align: center !important;">RW</th>
                                <th style="text-align: center !important;">STATUS</th>
                                <th style="text-align: center !important;">ACTION</th>
                            </tr>
                        </thead>
                        <tbody>
                            @foreach ($familys as $item)
                                <tr style="text-align: center !important;">
                                    <td style="text-align: center !important;"> {{ $item->id }} </td>
                                    <td style="text-align: center !important;"> {{ $item->no_kk }} </td>
                                    <td> {{ $item->name }} </td>
                                    <td> {{ $item->address }} </td>
                                    <td style="text-align: center !important;"> {{ $item->phone_number }} </td>
                                    <td> {{ $item->family_card_identity }} </td>
                                    <td> {{ $item->wilayah }} </td>
                                    <td style="text-align: center !important;"> {{ $item->rt }} </td>
                                    <td style="text-align: center !important;"> {{ $item->rw }} </td>
                                    @if ($item->active_status === 1)
                                        <td>
                                            <div class="badge badge-success">Active</div>
                                        </td>
                                    ...
                                    @endif
                                    <td>
                                        <a href="{{ route('kartu-keluarga.download', $item) }}" class="btn btn-sm btn-primary">Download</a>
                                        <a href="{{ route('kartu-keluarga.destroy', $item->id) }}" class="btn btn-danger"
