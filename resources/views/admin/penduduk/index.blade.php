    ...
    <div class="col-md-6 col-lg-12">
        <div class="card">
            <div class="card-header">
                <h4>Seluruh Data Penduduk</h4>
            </div>
            <div class="card-body p-0">
                <p class="px-4">Berikut adalah daftar seluruh Penduduk.</p>
                    ...
                    <table id="example" class="table table-striped" style="width:100%">
                        <thead>
                            <tr>
                                ...
                                <th style="text-align: center !important;">KTP</th>
                                <th style="text-align: center !important;">No HP</th>
                                <th style="text-align: center !important;">Alamat</th>
                                <th style="text-align: center !important;">Kelamin</th>
                                <th style="text-align: center !important;">ACTION</th>
                            </tr>
                        </thead>
                        <tbody>
                            @foreach ($villagers as $item)
                                <tr style="text-align: center !important;">
                                    ...
                                    <td> {{ $item->gender }} </td>
                                    <td>
                                        <a href="{{ route('penduduk.destroy', $item->id) }}" class="btn btn-danger"
                                            data-confirm-delete="true">Delete</a>
                                        <a href="{{ route('penduduk.edit', $item->id) }}" class="btn btn-warning">Edit</a>
                                        <a href="{{ route('penduduk.show', $item->id) }}" class="btn btn-info">Detail</a>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
